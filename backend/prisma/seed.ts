  ...
  const warehouses = [
    ...
    await prisma.warehouse.upsert({
      ...
      create: {
        name: "Pune West Hub",
        code: "PNQ-W2",
        location: { lat: 18.5204, lng: 73.8567, address: "Hinjewadi IT Park", city: "Pune", region: "west" },
        capacity: 900,
        currentLoad: 210,
        utilizationPct: 23.3,
        throughputRate: 110,
    ...
    await prisma.warehouse.upsert({
      ...
      create: {
        ...
        code: "NAG-C1",
        location: { lat: 21.1458, lng: 79.0882, address: "MIHAN SEZ", city: "Nagpur", region: "central" },
        capacity: 800,
        currentLoad: 150,
        utilizationPct: 18.8,
        throughputRate: 100,
    ...
    await prisma.warehouse.upsert({
      ...
      create: {
        ...
        code: "MAA-S3",
        location: { lat: 13.0827, lng: 80.2707, address: "Sriperumbudur Industrial Area", city: "Chennai", region: "south" },
        capacity: 850,
        currentLoad: 270,
        utilizationPct: 31.8,
        throughputRate: 105,
    ...
    await prisma.warehouse.upsert({
      ...
      update: {},
      create: {
        name: "Mumbai Navi Hub",
        code: "MUM-W2",
        location: { lat: 19.033, lng: 73.0297, address: "Taloja MIDC, Navi Mumbai", city: "Mumbai", region: "west" },
        capacity: 1100,
        currentLoad: 935,
        utilizationPct: 85.0,
        throughputRate: 140,
